--- Made by Turko!#0066 please add me on discord, or join my discord: discord.gg/tDev for any support on this resource.
...
local recoils = {
	...
	-- pistols
	[416676503] = 0.34, -- Recoil settings 0.34 by default

	--smg
	[-957766203] = 0.22, -- Recoil settings 0.22 by default

	-- rifles
	[970310034] = 0.17, -- Recoil settings 0.17 by default
